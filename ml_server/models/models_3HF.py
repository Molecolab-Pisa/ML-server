...
"""
3-hydroxyflavone models for ground- and excited-state ML/MM simulations.
...
Also, copy the model files (model*.npz) in ml_server/avail_models.
"""
...
AVAIL_MODELS_DIR = os.path.join(os.path.dirname(__file__), "avail_models/3HF")
